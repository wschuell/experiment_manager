...
class BatchExp(object):
	...
	def __init__(self, name=None, jq_cfg = None, estimated_time=1200, db_cfg=None, db=None, other_dbs=[], other_dbs_lookup=True, auto_job=True, profiling=False, virtual_env=None, requirements=[], **kwargs):
...
#		self.control_exp(exp)
	...
	def get_graph(self, xp_uuid, method, tmin=0, tmax=None,no_storage=False):
